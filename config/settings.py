...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
     'subscriptions',  # ← AJOUTEZ JUSTE CETTE LIGNE
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'johanharirojo@gmail.com'  # Remplacez par votre email
EMAIL_HOST_PASSWORD = 'dyvo'  # Remplacez par votre mot de passe d'application
