...
def get_advanced_stats():
    """Récupérer des statistiques avancées pour le tableau de bord"""
    ...
    # Chiffre d'affaires
    chiffre_affaires = Subscription.objects.aggregate(total=Sum('prix'))['total'] or 0
    
    # Abonnements créés ce mois-ci
...
def generate_clients_chart():
    ...
    sizes = [stats['repartition_clients']['personnel'], stats['repartition_clients']['entreprise']]
